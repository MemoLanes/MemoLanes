...
impl JourneyKind {
    ...
    pub fn of_proto(proto: protos::journey::header::Kind) -> Self {
        ...
        if proto.has_custom_kind() {
            ...
            panic!("custom journey kind is not supported, custom_kind = {custom_kind}")
        }
...
impl JourneyHeader {
    ...
    pub fn of_proto(mut proto: protos::journey::Header) -> Result<Self> {
        ...
        Ok(JourneyHeader {
            ...
            has_raw_data: proto.has_raw_data.unwrap_or(false),
        })
    }

    pub fn correct_has_raw_data(&mut self, actual_has_raw_data: bool, operation: &str) {
        if self.has_raw_data != actual_has_raw_data {
            ...
            self.has_raw_data = actual_has_raw_data;
        }
    }
    ...
    pub fn to_proto(self) -> protos::journey::Header {
        ...
        proto.has_raw_data = Some(has_raw_data);
        proto
    }
}
