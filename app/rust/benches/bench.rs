...
fn journey_area_calculation(c: &mut Criterion) {
    ...
    group.bench_function(
        ...
        |b| {
            ...
            let journey_vector =
                import_data::journey_vector_from_raw_data_with_gps_preprocessor(&raw_data, false).unwrap();
...
fn journey_bitmap(c: &mut Criterion) {
    ...
    group.bench_function("add_journey_vector_to_journey_bitmap", |b| {
        let load_journey_vector = |name| {
            ...
            import_data::journey_vector_from_raw_data_with_gps_preprocessor(&raw_data, true).unwrap()
        };
