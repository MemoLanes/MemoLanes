...
if __name__ == "__main__":
    ...
    generate_netrc("api.mapbox.com", "mapbox", data.get("MAPBOX-SDK-REGISTRY-TOKEN",""))
    generate_gradle_token(data.get("MAPBOX-SDK-REGISTRY-TOKEN",""))
    generate_token_dart(data.get("MAPBOX-ACCESS-TOKEN",""))